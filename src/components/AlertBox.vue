...
export default {
  ...
  data() {
    return {
      msg: this.$error.msg.value,
      close: this.$error.setMessage
    }
  }
}
</script>
...
<template>
  <Modal>
    ...
    <div class="flex flex-col items-center my-10">
      <p>{{msg}}</p>
      <p>We were unable to find the droids you were looking for.</p>
      <p>Please try again later.</p>
    </div>
    <button @click.prevent.stop="close()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Close</button>
  </Modal>
</template>
